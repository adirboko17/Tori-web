import { iconPaths } from "@/components/ui/media/icon-paths.js";

// Lucide v0.469.0 (ISC) geometry for admin-only icons missing from the shared set.
const adminPaths = {
  "layout-dashboard":
...
const paths: Record<string, string> = { ...iconPaths, ...adminPaths };

export type IconName = keyof typeof iconPaths | keyof typeof adminPaths;
...
export function Icon({
  ...
  return (
    <svg
      className={`ad-icon ${className}`.trim()}
